...
import { renderAsync } from 'node_modules/@react-email/render/dist/browser';
...
interface RecoveryPasswordEmailProps {
  ...
  finebankProductionLink?: string;
}

export default function RecoveryPasswordEmail(
  props: RecoveryPasswordEmailProps
) {
  const { userFirstLastName, resetPasswordLink, finebankProductionLink } =
    props;
...
export const HtmlRecoveryPasswordEmail = async (
  props: RecoveryPasswordEmailProps
) => await renderAsync(<RecoveryPasswordEmail {...props} />, { pretty: true });
